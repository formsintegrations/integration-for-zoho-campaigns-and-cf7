  ...
  return (
    <div>
      {dataConf?.condition && edit && (
        <>
          <div className="flx">
            <TableCheckBox onChange={e => checkedCondition(e.target.value, e.target.checked)} checked={dataConf?.condition?.action_behavior === 'cond'} className="wdt-200 mt-4 mr-2" value="cond" title={__('Conditional Logics', 'integration-for-zoho-campaigns-and-cf7')} />
          </div>
          <br />
