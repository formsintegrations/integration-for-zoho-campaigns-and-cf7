  ...
  return (
    <div style={{ ...{ width: isInfo && 900 } }}>
      ...
      {webHooks?.condition && (
        <>
          <div className="flx">
            <TableCheckBox onChange={e => checkedCondition(e.target.value, e.target.checked)} checked={webHooks?.condition?.action_behavior === 'cond'} className="wdt-200 mt-4 mr-2" value="cond" title={__('Conditional Logics', 'fitzocacf')} isInfo={isInfo} />
          </div>
          <br />
