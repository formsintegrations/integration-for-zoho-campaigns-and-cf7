      ...
      {id === '5' && flow.triggerData.selectedQuiz
        && (
          <>
            ...
            />
            <h4>Target Value</h4>
            <input className="btcd-paper-inp w-10 mt-1" onChange={(e) => setFlowData(e.target.value, 'requiredPercent')} name="requiredPercent" value={flow?.triggerData?.requiredPercent} type="text" placeholder={__('Targeted Percentage Value(ex: 50)', 'fitzocacf')} />
          </>
        )}
      <div />
    </div>
